function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var filteredlist = samplelist.filter(data => data.id == sample);
      //  5. Create a variable that holds the first sample in the array.
      var resultlist = filteredlist[0];
  
      // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
      var otu_id = resultlist.otu_ids;
      var otu_labels = resultlist.otu_labels;
      var sample_values = resultlist.sample_values;
      ...
      var firstdata = metadataFilter[0];
      // 3. Create a variable that holds the washing frequency.
      var washFreq = firstdata.wfreq;
